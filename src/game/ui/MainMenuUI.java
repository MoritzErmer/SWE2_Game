 ...
 * Uses CompletableFuture so the caller can block on .get() from a non-EDT thread.
 */
    ...
    public MainMenuUI() {
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                fm = g.getFontMetrics();
                g.drawString(sub, (getWidth() - fm.stringWidth(sub)) / 2, 130);
            }
        };
        panel.setLayout(null);

        JButton playBtn = createMenuButton("Spielen", new Color(60, 160, 60));
        playBtn.setBounds(175, 170, 250, 50);
        ...
        creativeBtn.setBounds(175, 235, 250, 50);
        ...
        loadBtn.setBounds(175, 300, 250, 50);
